                        ...
                        {props.lista.map((row) => (
                            ...
                            >
                                ...
                                <TableCell align="center">
                                    ...
                                    <Button
                                        variant="contained"
                                        href={"/sistemaSolar/"+ row.id_sistema+"/planeta/"+row.id_planeta}
                                    >
                                        Editar
                                    </Button>
                                </TableCell>
...
export async function getServerSideProps(context: any) {
    ...
    const res = await fetch('http://localhost:3000/api/sistemaSolar/' + context.params.sistemaSolarId +"?planetas=true", {
        method: 'GET',
    })
